...
export class MemberApi {
    ...
    public chakanxiaji(data, showLoadingModal: boolean = true) {
        var url = ApiConfig.getApiUrl() + 'member/chakanxiaji';
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('member/chakanxiaji', data, res)) {
                    if (showLoadingModal) {
            ...
            .catch(err => {
                ...
                return ApiConfig.ErrorHandle('member/chakanxiaji', data, err);
            });
    }
    ...
    public favcourselist(data, showLoadingModal: boolean = true) {
        var url = ApiConfig.getApiUrl() + 'member/favcourselist';
        var headers = ApiConfig.GetHeader(url, data);
        let options = new RequestOptions({ headers: headers });
        let body = ApiConfig.ParamUrlencoded(data);
        let loading = null;
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('member/favcourselist', data, res)) {
                    if (showLoadingModal) {
                        ApiConfig.DimissLoadingModal();
                    }
                    if (res==null) {
            ...
            .catch(err => {
                ...
                return ApiConfig.ErrorHandle('member/favcourselist', data, err);
            });
    }


    public favjigoulist(data, showLoadingModal: boolean = true) {
        var url = ApiConfig.getApiUrl() + 'member/favjigoulist';
        var headers = ApiConfig.GetHeader(url, data);
        let options = new RequestOptions({ headers: headers });
        let body = ApiConfig.ParamUrlencoded(data);
        let loading = null;
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('member/favjigoulist', data, res)) {
                    if (showLoadingModal) {
                        ApiConfig.DimissLoadingModal();
                    }
                    if (res==null) {
            ...
            .catch(err => {
                ...
                return ApiConfig.ErrorHandle('member/favjigoulist', data, err);
            });
    }


    public favvideolist(data, showLoadingModal: boolean = true) {
        var url = ApiConfig.getApiUrl() + 'member/favvideolist';
        var headers = ApiConfig.GetHeader(url, data);
        let options = new RequestOptions({ headers: headers });
        let body = ApiConfig.ParamUrlencoded(data);
        let loading = null;
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('member/favvideolist', data, res)) {
                    if (showLoadingModal) {
                        ApiConfig.DimissLoadingModal();
                    }
                    if (res==null) {
            ...
            .catch(err => {
                ...
                return ApiConfig.ErrorHandle('member/favvideolist', data, err);
            });
    }
    ...
    public updateh5(data, showLoadingModal: boolean = true) {
        ...
        return this.http.post(url, body, options).toPromise()
            ...
            .catch(err => {
                ...
                return ApiConfig.ErrorHandle('member/updateh5', data, err);
            });
    }
    ...
    public updatemobile(data, showLoadingModal: boolean = true) {
        var url = ApiConfig.getApiUrl() + 'member/updatemobile';
        var headers = ApiConfig.GetHeader(url, data);
        let options = new RequestOptions({ headers: headers });
        let body = ApiConfig.ParamUrlencoded(data);
        let loading = null;
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('member/updatemobile', data, res)) {
                    if (showLoadingModal) {
                        ApiConfig.DimissLoadingModal();
                    }
                    if (res==null) {
            ...
            .catch(err => {
                ...
                return ApiConfig.ErrorHandle('member/updatemobile', data, err);
            });
    }


    public usecity(data, showLoadingModal: boolean = true) {
        var url = ApiConfig.getApiUrl() + 'member/usecity';
        var headers = ApiConfig.GetHeader(url, data);
        let options = new RequestOptions({ headers: headers });
        let body = ApiConfig.ParamUrlencoded(data);
        let loading = null;
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('member/usecity', data, res)) {
                    if (showLoadingModal) {
                        ApiConfig.DimissLoadingModal();
                    }
                    if (res==null) {
            ...
            .catch(err => {
                ...
                return ApiConfig.ErrorHandle('member/usecity', data, err);
            });
    }


    public usecitylist(data, showLoadingModal: boolean = true) {
        var url = ApiConfig.getApiUrl() + 'member/usecitylist';
        var headers = ApiConfig.GetHeader(url, data);
        let options = new RequestOptions({ headers: headers });
        let body = ApiConfig.ParamUrlencoded(data);
        let loading = null;
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('member/usecitylist', data, res)) {
                    if (showLoadingModal) {
                        ApiConfig.DimissLoadingModal();
                    }
                    if (res==null) {
            ...
            .catch(err => {
                ...
                return ApiConfig.ErrorHandle('member/usecitylist', data, err);
            });
    }
