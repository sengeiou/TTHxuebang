...
export class InstApi {
    ...
    public city(data, showLoadingModal: boolean = true) {
        var url = ApiConfig.getApiUrl() + 'inst/city';
        var headers = ApiConfig.GetHeader(url, data);
        let options = { headers: headers };
        let body = ApiConfig.ParamUrlencoded(data);
        let loading = null;
        ...
        return this.http.post(url, body, options).toPromise()
            ...
            .catch(err => {
                console.error(err);
                return ApiConfig.ErrorHandle('inst/city', data, err);
            });
    }


    public district(data, showLoadingModal: boolean = true) {
        var url = ApiConfig.getApiUrl() + 'inst/district';
        var headers = ApiConfig.GetHeader(url, data);
        let options = { headers: headers };
        let body = ApiConfig.ParamUrlencoded(data);
        let loading = null;
        ...
        return this.http.post(url, body, options).toPromise()
            ...
            .catch(err => {
                console.error(err);
                return ApiConfig.ErrorHandle('inst/district', data, err);
            });
    }
    ...
    public label(data, showLoadingModal: boolean = true) {
        var url = ApiConfig.getApiUrl() + 'inst/label';
        var headers = ApiConfig.GetHeader(url, data);
        let options = { headers: headers };
        let body = ApiConfig.ParamUrlencoded(data);
        let loading = null;
        ...
        return this.http.post(url, body, options).toPromise()
            ...
            .catch(err => {
                console.error(err);
                return ApiConfig.ErrorHandle('inst/label', data, err);
            });
    }
    ...
    public province(data, showLoadingModal: boolean = true) {
        var url = ApiConfig.getApiUrl() + 'inst/province';
        var headers = ApiConfig.GetHeader(url, data);
        let options = { headers: headers };
        let body = ApiConfig.ParamUrlencoded(data);
        let loading = null;
        ...
        return this.http.post(url, body, options).toPromise()
            ...
            .catch(err => {
                console.error(err);
                return ApiConfig.ErrorHandle('inst/province', data, err);
            });
    }
    ...
    public street(data, showLoadingModal: boolean = true) {
        var url = ApiConfig.getApiUrl() + 'inst/street';
        var headers = ApiConfig.GetHeader(url, data);
        let options = { headers: headers };
        let body = ApiConfig.ParamUrlencoded(data);
        let loading = null;
        ...
        return this.http.post(url, body, options).toPromise()
            ...
            .catch(err => {
                console.error(err);
                return ApiConfig.ErrorHandle('inst/street', data, err);
            });
    }
