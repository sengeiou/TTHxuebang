...
export class MemberApi{
    ...
    chakanxiaji(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'member/chakanxiaji',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
    ...
    clearkeyword(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'member/clearkeyword',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
    ...
    favcourselist(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'member/favcourselist',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
    ...
    favjigoulist(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'member/favjigoulist',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
    ...
    favvideolist(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'member/favvideolist',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
    ...
    updateh5(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'member/updateh5',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
    ...
    usecity(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'member/usecity',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
    ...
    usecitylist(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'member/usecitylist',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
