...
export class JigouApi {
    ...
    public aboutus(data, showLoadingModal: boolean = true) {
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('jigou/aboutus', data, res)) {
                    if (showLoadingModal) {
    ...
    public activecity(data, showLoadingModal: boolean = true) {
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('jigou/activecity', data, res)) {
                    if (showLoadingModal) {
                        ApiConfig.DimissLoadingModal();
                    }
                    if (res==null) {
    ...
    public activedistrictlist(data, showLoadingModal: boolean = true) {
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('jigou/activedistrictlist', data, res)) {
                    if (showLoadingModal) {
                        ApiConfig.DimissLoadingModal();
                    }
                    if (res==null) {
    ...
    public addgroup(data, showLoadingModal: boolean = true) {
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('jigou/addgroup', data, res)) {
                    if (showLoadingModal) {
                        ApiConfig.DimissLoadingModal();
                    }
                    if (res==null) {
    ...
    public addjigou(data, showLoadingModal: boolean = true) {
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('jigou/addjigou', data, res)) {
                    if (showLoadingModal) {
                        ApiConfig.DimissLoadingModal();
                    }
                    if (res==null) {
    ...
    public addshenqing(data, showLoadingModal: boolean = true) {
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('jigou/addshenqing', data, res)) {
                    if (showLoadingModal) {
                        ApiConfig.DimissLoadingModal();
                    }
                    if (res==null) {
    ...
    public addxueyuan(data, showLoadingModal: boolean = true) {
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('jigou/addxueyuan', data, res)) {
                    if (showLoadingModal) {
                        ApiConfig.DimissLoadingModal();
                    }
                    if (res==null) {
    ...
    public buyshow(data, showLoadingModal: boolean = true) {
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('jigou/buyshow', data, res)) {
                    if (showLoadingModal) {
                        ApiConfig.DimissLoadingModal();
                    }
                    if (res==null) {
    ...
    public checkcanbuy(data, showLoadingModal: boolean = true) {
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('jigou/checkcanbuy', data, res)) {
                    if (showLoadingModal) {
                        ApiConfig.DimissLoadingModal();
                    }
                    if (res==null) {
    ...
    public courseage(data, showLoadingModal: boolean = true) {
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('jigou/courseage', data, res)) {
                    if (showLoadingModal) {
                        ApiConfig.DimissLoadingModal();
                    }
                    if (res==null) {
    ...
    public coursefav(data, showLoadingModal: boolean = true) {
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('jigou/coursefav', data, res)) {
                    if (showLoadingModal) {
                        ApiConfig.DimissLoadingModal();
                    }
                    if (res==null) {
    ...
    public courseinfo(data, showLoadingModal: boolean = true) {
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('jigou/courseinfo', data, res)) {
                    if (showLoadingModal) {
                        ApiConfig.DimissLoadingModal();
                    }
                    if (res==null) {
    ...
    public courselist(data, showLoadingModal: boolean = true) {
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('jigou/courselist', data, res)) {
                    if (showLoadingModal) {
                        ApiConfig.DimissLoadingModal();
                    }
                    if (res==null) {
    ...
    public coursetype(data, showLoadingModal: boolean = true) {
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('jigou/coursetype', data, res)) {
                    if (showLoadingModal) {
                        ApiConfig.DimissLoadingModal();
                    }
                    if (res==null) {
    ...
    public fenxiaoinfo(data, showLoadingModal: boolean = true) {
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('jigou/fenxiaoinfo', data, res)) {
                    if (showLoadingModal) {
                        ApiConfig.DimissLoadingModal();
                    }
                    if (res==null) {
    ...
    public fenxiaoshenhe(data, showLoadingModal: boolean = true) {
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('jigou/fenxiaoshenhe', data, res)) {
                    if (showLoadingModal) {
                        ApiConfig.DimissLoadingModal();
                    }
                    if (res==null) {
    ...
    public gongaolist(data, showLoadingModal: boolean = true) {
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('jigou/gongaolist', data, res)) {
                    if (showLoadingModal) {
                        ApiConfig.DimissLoadingModal();
                    }
                    if (res==null) {
    ...
    public huiyuan(data, showLoadingModal: boolean = true) {
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('jigou/huiyuan', data, res)) {
                    if (showLoadingModal) {
                        ApiConfig.DimissLoadingModal();
                    }
                    if (res==null) {
    ...
    public jginfo(data, showLoadingModal: boolean = true) {
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('jigou/jginfo', data, res)) {
                    if (showLoadingModal) {
                        ApiConfig.DimissLoadingModal();
                    }
                    if (res==null) {
    ...
    public jglist(data, showLoadingModal: boolean = true) {
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('jigou/jglist', data, res)) {
                    if (showLoadingModal) {
                        ApiConfig.DimissLoadingModal();
                    }
                    if (res==null) {
    ...
    public jianchapintuan(data, showLoadingModal: boolean = true) {
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('jigou/jianchapintuan', data, res)) {
                    if (showLoadingModal) {
                        ApiConfig.DimissLoadingModal();
                    }
                    if (res==null) {
    ...
    public jigoufav(data, showLoadingModal: boolean = true) {
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('jigou/jigoufav', data, res)) {
                    if (showLoadingModal) {
                        ApiConfig.DimissLoadingModal();
                    }
                    if (res==null) {
    ...
    public jigouimg(data, showLoadingModal: boolean = true) {
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('jigou/jigouimg', data, res)) {
                    if (showLoadingModal) {
                        ApiConfig.DimissLoadingModal();
                    }
                    if (res==null) {
    ...
    public kechenlunbo(data, showLoadingModal: boolean = true) {
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('jigou/kechenlunbo', data, res)) {
                    if (showLoadingModal) {
                        ApiConfig.DimissLoadingModal();
                    }
                    if (res==null) {
    ...
    public kechenzhanjie(data, showLoadingModal: boolean = true) {
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('jigou/kechenzhanjie', data, res)) {
                    if (showLoadingModal) {
                        ApiConfig.DimissLoadingModal();
                    }
                    if (res==null) {
    ...
    public ketanglist(data, showLoadingModal: boolean = true) {
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('jigou/ketanglist', data, res)) {
                    if (showLoadingModal) {
                        ApiConfig.DimissLoadingModal();
                    }
                    if (res==null) {
    ...
    public ketanpinlun(data, showLoadingModal: boolean = true) {
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('jigou/ketanpinlun', data, res)) {
                    if (showLoadingModal) {
                        ApiConfig.DimissLoadingModal();
                    }
                    if (res==null) {
    ...
    public ketanpinlunlist(data, showLoadingModal: boolean = true) {
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('jigou/ketanpinlunlist', data, res)) {
                    if (showLoadingModal) {
                        ApiConfig.DimissLoadingModal();
                    }
                    if (res==null) {
    ...
    public keywordlist(data, showLoadingModal: boolean = true) {
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('jigou/keywordlist', data, res)) {
                    if (showLoadingModal) {
                        ApiConfig.DimissLoadingModal();
                    }
                    if (res==null) {
    ...
    public latestbuy(data, showLoadingModal: boolean = true) {
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('jigou/latestbuy', data, res)) {
                    if (showLoadingModal) {
                        ApiConfig.DimissLoadingModal();
                    }
                    if (res==null) {
    ...
    public liuchen(data, showLoadingModal: boolean = true) {
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('jigou/liuchen', data, res)) {
                    if (showLoadingModal) {
                        ApiConfig.DimissLoadingModal();
                    }
                    if (res==null) {
    ...
    public newkcinfo(data, showLoadingModal: boolean = true) {
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('jigou/newkcinfo', data, res)) {
                    if (showLoadingModal) {
                        ApiConfig.DimissLoadingModal();
                    }
                    if (res==null) {
    ...
    public newkclist(data, showLoadingModal: boolean = true) {
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('jigou/newkclist', data, res)) {
                    if (showLoadingModal) {
                        ApiConfig.DimissLoadingModal();
                    }
                    if (res==null) {
    ...
    public opengroup(data, showLoadingModal: boolean = true) {
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('jigou/opengroup', data, res)) {
                    if (showLoadingModal) {
                        ApiConfig.DimissLoadingModal();
                    }
                    if (res==null) {
    ...
    public pinlundianzan(data, showLoadingModal: boolean = true) {
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('jigou/pinlundianzan', data, res)) {
                    if (showLoadingModal) {
                        ApiConfig.DimissLoadingModal();
                    }
                    if (res==null) {
    ...
    public pinlunhuifudianzan(data, showLoadingModal: boolean = true) {
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('jigou/pinlunhuifudianzan', data, res)) {
                    if (showLoadingModal) {
                        ApiConfig.DimissLoadingModal();
                    }
                    if (res==null) {
    ...
    public pintuaninfo(data, showLoadingModal: boolean = true) {
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('jigou/pintuaninfo', data, res)) {
                    if (showLoadingModal) {
                        ApiConfig.DimissLoadingModal();
                    }
                    if (res==null) {
    ...
    public pintuanlist(data, showLoadingModal: boolean = true) {
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('jigou/pintuanlist', data, res)) {
                    if (showLoadingModal) {
                        ApiConfig.DimissLoadingModal();
                    }
                    if (res==null) {
    ...
    public problemlist(data, showLoadingModal: boolean = true) {
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('jigou/problemlist', data, res)) {
                    if (showLoadingModal) {
                        ApiConfig.DimissLoadingModal();
                    }
                    if (res==null) {
    ...
    public qrcode(data, showLoadingModal: boolean = true) {
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('jigou/qrcode', data, res)) {
                    if (showLoadingModal) {
                        ApiConfig.DimissLoadingModal();
                    }
                    if (res==null) {
    ...
    public quanyilist(data, showLoadingModal: boolean = true) {
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('jigou/quanyilist', data, res)) {
                    if (showLoadingModal) {
                        ApiConfig.DimissLoadingModal();
                    }
                    if (res==null) {
    ...
    public shanchuxueyuan(data, showLoadingModal: boolean = true) {
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('jigou/shanchuxueyuan', data, res)) {
                    if (showLoadingModal) {
                        ApiConfig.DimissLoadingModal();
                    }
                    if (res==null) {
    ...
    public videofav(data, showLoadingModal: boolean = true) {
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('jigou/videofav', data, res)) {
                    if (showLoadingModal) {
                        ApiConfig.DimissLoadingModal();
                    }
                    if (res==null) {
    ...
    public xieyi(data, showLoadingModal: boolean = true) {
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('jigou/xieyi', data, res)) {
                    if (showLoadingModal) {
                        ApiConfig.DimissLoadingModal();
                    }
                    if (res==null) {
    ...
    public xueyuaninfo(data, showLoadingModal: boolean = true) {
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('jigou/xueyuaninfo', data, res)) {
                    if (showLoadingModal) {
                        ApiConfig.DimissLoadingModal();
                    }
                    if (res==null) {
    ...
    public xueyuanlist(data, showLoadingModal: boolean = true) {
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('jigou/xueyuanlist', data, res)) {
                    if (showLoadingModal) {
                        ApiConfig.DimissLoadingModal();
                    }
                    if (res==null) {
    ...
    public yaoqin(data, showLoadingModal: boolean = true) {
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('jigou/yaoqin', data, res)) {
                    if (showLoadingModal) {
                        ApiConfig.DimissLoadingModal();
                    }
                    if (res==null) {
    ...
    public zaixiankechenfenlei(data, showLoadingModal: boolean = true) {
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('jigou/zaixiankechenfenlei', data, res)) {
                    if (showLoadingModal) {
                        ApiConfig.DimissLoadingModal();
                    }
                    if (res==null) {
    ...
    public zaixiankecheninfo(data, showLoadingModal: boolean = true) {
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('jigou/zaixiankecheninfo', data, res)) {
                    if (showLoadingModal) {
                        ApiConfig.DimissLoadingModal();
                    }
                    if (res==null) {
    ...
    public zaixiankechenlist(data, showLoadingModal: boolean = true) {
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('jigou/zaixiankechenlist', data, res)) {
                    if (showLoadingModal) {
                        ApiConfig.DimissLoadingModal();
                    }
                    if (res==null) {
    ...
    public zaixiankechenshoucan(data, showLoadingModal: boolean = true) {
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('jigou/zaixiankechenshoucan', data, res)) {
                    if (showLoadingModal) {
                        ApiConfig.DimissLoadingModal();
                    }
                    if (res==null) {
    ...
    public zaixianketanlunbo(data, showLoadingModal: boolean = true) {
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('jigou/zaixianketanlunbo', data, res)) {
                    if (showLoadingModal) {
                        ApiConfig.DimissLoadingModal();
                    }
                    if (res==null) {
